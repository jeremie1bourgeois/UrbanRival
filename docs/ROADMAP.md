...
| Infiltrated (Oculus) — règle officielle : un seul autre clan → celui-là ; deux → celui de la **carte seule** ; trois ou deux Oculus → rien. Un Leader compte comme un clan, et l'Oculus qui le rejoint compte comme second Leader (Cancel Leader) — combat réel 1346878 (2026-09-21) ; la liste des clans imprimée sur la carte ne restreint que le bonus adopté et l'ability | `process_round.infiltrated_clan`, `data/ur_battles/1346878.json` |
