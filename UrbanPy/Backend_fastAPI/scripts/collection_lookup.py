"""Cherche dans la collection du compte (data/collection/ma_collection.json) les cartes dont le pouvoir correspond
à un motif, pour composer les decks de docs/ORACLE.md avec des cartes possédées.
...
COLLECTION_PATH = ROOT / "data" / "collection" / "ma_collection.json"
