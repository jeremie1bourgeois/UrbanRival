...
def _one(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return 1


def _growth(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return game.nb_turn


def _degrowth(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return 5 - game.nb_turn


def _support(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
...
def _equalizer(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return card2.stars


def _brawl(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return sum(1 for c in player2.cards if clan_for_bonus(player2, c) == clan_for_bonus(player2, card2))


def _nb_damage_opp(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return card2.damage


def _nb_power_opp(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return card2.power
...
def _nb_life_left(game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
    return player1.life
...
def multiplier(how: str, game: Game, player1: Player, player2: Player, card1: Card, card2: Card) -> int:
