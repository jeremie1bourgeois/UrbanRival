...
def apply_cancel_data_modif(capacity: Capacity, capacity_opp_1: Capacity, capacity_opp_2: Capacity) -> Tuple[Capacity, Capacity]:
    ...
    if capacity.how == "cancel":
        if "power" in capacity.types:
            if capacity_opp_1 and "power" in capacity_opp_1.types and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and "power" in capacity_opp_2.types and capacity_opp_2.how not in list_how_not_cancel:
                if not capacity_opp_1: return (None, None)
                capacity_opp_2 = None
        elif "damage" in capacity.types:
            if capacity_opp_1 and "damage" in capacity_opp_1.types and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and "damage" in capacity_opp_2.types and capacity_opp_2.how not in list_how_not_cancel:
                if not capacity_opp_1: return (None, None)
                capacity_opp_2 = None
        elif "attack" in capacity.types:
            if capacity_opp_1 and "attack" in capacity_opp_1.types and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and "attack" in capacity_opp_2.types and capacity_opp_2.how not in list_how_not_cancel:
                if not capacity_opp_1: return (None, None)
                capacity_opp_2 = None
        elif all(x in capacity.types for x in ["power", "damage"]):
            if capacity_opp_1 and ("power" in capacity_opp_1.types or "damage" in capacity_opp_1.types or all(x in capacity_opp_1.types for x in ["power", "damage"])) and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and ("power" in capacity_opp_2.types or "damage" in capacity_opp_2.types or all(x in capacity_opp_2.types for x in ["power", "damage"])) and capacity_opp_2.how not in list_how_not_cancel:
                if not capacity_opp_1: return (None, None)
                capacity_opp_2 = None
        elif "life" in capacity.types:
            if capacity_opp_1 and "life" in capacity_opp_1.types and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and "life" in capacity_opp_2.types and capacity_opp_2.how not in list_how_not_cancel:
                if not capacity_opp_1: return (None, None)
                capacity_opp_2 = None
        elif "pillz" in capacity.types:
            if capacity_opp_1 and "pillz" in capacity_opp_1.types and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and "pillz" in capacity_opp_2.types and capacity_opp_2.how not in list_how_not_cancel:
                if not capacity_opp_1: return (None, None)
                capacity_opp_2 = None
        elif all(x in capacity.types for x in ["life", "pillz"]):
            if capacity_opp_1 and ("pillz" in capacity_opp_1.types or "life" in capacity_opp_1.types or all(x in capacity_opp_1.types for x in ["pillz", "life"])) and capacity_opp_1.how not in list_how_not_cancel:
                if not capacity_opp_2: return (None, None)
                capacity_opp_1 = None
            if capacity_opp_2 and ("pillz" in capacity_opp_2.types or "life" in capacity_opp_2.types or all(x in capacity_opp_2.types for x in ["pillz", "life"])) and capacity_opp_2.how not in list_how_not_cancel:
                return (capacity_opp_1, None)
