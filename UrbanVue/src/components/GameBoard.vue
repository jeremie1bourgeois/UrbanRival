		...
		>
			...
			<div class="w-full flex flex-col items-center">
				...
				<div class="flex flex-wrap justify-center gap-4">
					<Card v-for="(card, index) in game.enemy.cards" :key="'enemy-' + index" :card="card" :pillz="game.enemy.pillz" />
				</div>
			</div>
			<div class="w-full border-t border-gray-600 my-4"></div>
			<div class="w-full flex flex-col items-center">
				<div class="flex flex-wrap justify-center gap-4">
					<Card v-for="(card, index) in game.ally.cards" :key="'ally-' + index" :card="card" :pillz="game.ally.pillz" />
				</div>
